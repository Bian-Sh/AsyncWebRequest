...
<root>
  ...
  ├── Editor
  │   ├── Bshsf9527.AsyncWebRequest.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Bshsf9527.AsyncWebRequest.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Bshsf9527.AsyncWebRequest.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Bshsf9527.AsyncWebRequest.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Bshsf9527.AsyncWebRequest`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Async Web Request Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Bshsf9527.AsyncWebRequest.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Bshsf9527.AsyncWebRequest.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Bshsf9527.AsyncWebRequest.Editor.Tests.asmdef`

  `Tests/Runtime/Bshsf9527.AsyncWebRequest.Tests.asmdef`
...
Use the `Documentations~/Async Web Request.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
